...
namespace Tests.Scheduling
{
    ...
    public class SchedulerDailyAtTests
    {
        ...
        public void ValidDailyAt_1pm(int[] first, int[] second)
        {
        ...
        public void ValidDailyAt_34MinAfterMidnight(int[] first, int[] second)
        {
            var scheduler = new Scheduler();
            int taskRunCount = 0;
        ...
        public void DailyAt_3pm_ShouldNeverRun(int[] first, int[] second)
        {
            var scheduler = new Scheduler();
            int taskRunCount = 0;
