...
public interface IQueue
{
    ...
    /// </summary>
    /// <param name="task">The task to be invoke by Coravel.</param>
    Guid QueueTask(Action task);

    /// <summary>
    /// Queue a new async task.
    /// </summary>
    /// <param name="asyncTask">The async task to be invoke by Coravel.</param>
    Guid QueueAsyncTask(Func<Task> asyncTask);
