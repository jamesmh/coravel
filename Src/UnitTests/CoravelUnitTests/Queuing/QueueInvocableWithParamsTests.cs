...
public class TestInvocable : IInvocable, IInvocableWithPayload<TestParams>
{
    ...
    private readonly Action<string, int> _func;

    public TestInvocable(Action<string, int> func) => _func = func;

    public Task Invoke()
    {
        _func(Payload.Name, Payload.Number);
    ...
    public class TestInvocableWithStringParam : IInvocable, IInvocableWithPayload<string>
{
    ...
    public TestInvocableWithStringParam(Action<string> func) => _func = func;
