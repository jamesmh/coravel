...
namespace CoravelUnitTests.Queuing
{
	public class QueueMetricTests
	{
		...
		public async Task TestAllGuidMethods()
		{
			...
			var guid5 = queue.QueueInvocableWithPayload<DummyInvocable, DummyParams>(new DummyParams());
	...
	public class DummyInvocable : IInvocable, ICancellableTask, IInvocableWithPayload<DummyParams>
	{
		public DummyInvocable() { }

		public DummyParams Payload { get; set; }
