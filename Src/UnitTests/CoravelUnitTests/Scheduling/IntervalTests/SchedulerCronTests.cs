...
namespace CoravelUnitTests.Scheduling.IntervalTests
{
    public class SchedulerCronTests
    {
        ...
        [InlineData("00 00 */2 * *", "8/3/2018 12:00 am", false)]
        [InlineData("00 00 */2 * *", "8/13/2018 12:00 am", false)]
        public async Task ScheduledEventCronWithCulture(string cronExpression, string dateString, bool shouldRun)
        {
            foreach(var culture in new string[] { "th-TH", "es-ES", "teo-KE", "bo-IN", "de-DE", "pt-BR", "fr-FR", "cs-CZ" })
            {
