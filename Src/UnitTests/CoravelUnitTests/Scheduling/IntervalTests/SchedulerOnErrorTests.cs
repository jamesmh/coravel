...
public class SchedulerOnErrorTests
{
    ...
    public async Task TestSchedulerHandlesErrors()
    {
        ...
        await scheduler.RunAtAsync(new DateTime(2019, 1, 1, 0, 0, 0, DateTimeKind.Utc)); // All tasks will run.
    ...
    public async Task TestSchedulerSkipsErrors()
    {
        ...
        await scheduler.RunAtAsync(new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc));
